...
function="xbyoneplussinx_heter"
log_name="denoise_results_heter.txt"
x_std_noise=0
uncertainty_model_train_mode='use_mean'
for seed in {1,2,3,4,5}
do
for y_std_noise in {0.707,1,1.414,2,2.828}
do
...
static_model_def=$2
for modes in "heter","fixed","fixed" "heter","heter","fixed" 
