...
class DataLoadPreprocess(Dataset):
    def __init__(self, args, mode, transform=None, is_for_online_eval=False):
        ...
        # self.samples = [None for _ in range(len(self.filenames))]
        self.samples = [None for _ in range(4)]
        self.__setall()
    ...
    def __set(self, idx):
        ...
        if self.mode == 'train':
            ...
            sample = {'image': image, 'depth': depth_gt, 'focal': focal, 'idx': idx}
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        if self.mode == 'train':
            ...
            return {'image': image, 'depth': depth, 'focal': focal, 'idx': sample['idx']}
        else:
